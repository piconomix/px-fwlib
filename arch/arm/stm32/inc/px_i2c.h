...
/** 
 *  @ingroup STM32
 *  @defgroup STM32_I2C px_i2c.h : I2C peripheral driver
 *  
 *  Driver to communicate with I2C slaves.
 *  
 *  File(s):
 *  - arch/arm/stm32/px_i2c.h
 *  - arch/arm/stm32/px_i2c_cfg_default.h
...
#if (   !defined(PX_I2C_CFG_I2C1_EN    ) \
     || !defined(PX_I2C_CFG_I2C2_EN    ) \
     || !defined(PX_I2C_CFG_TIMINGR)  )
#error "One or more options not defined in 'px_i2c_cfg.h'"
#endif
#if (   (PX_I2C_CFG_I2C1_EN > 1) \
     || (PX_I2C_CFG_I2C2_EN > 1) )
#error "PX_I2C_CFG_I2Cx_EN must be 0 or 1"
#endif

/// Number of enabled peripherals
#define PX_I2C_CFG_PER_COUNT   (   PX_I2C_CFG_I2C1_EN \
                                 + PX_I2C_CFG_I2C2_EN   )
