...
#define PX_EXTI_CFG_INT3_EN      0
#define PX_EXTI_CFG_INT4_EN      0
#define PX_EXTI_CFG_INT5_EN      0
#define PX_EXTI_CFG_INT6_EN      0
#define PX_EXTI_CFG_INT7_EN      0
#define PX_EXTI_CFG_INT8_EN      0
#define PX_EXTI_CFG_INT9_EN      1
#define PX_EXTI_CFG_INT10_EN     0
#define PX_EXTI_CFG_INT11_EN     0
#define PX_EXTI_CFG_INT12_EN     0
