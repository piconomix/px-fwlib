                                           ...
                                           char *             pin_str)
{
    ...
    else
    {
        ...
        case 'f':
            ...
            break;
#else
#warning "TODO! Need to check support for Port F"
#endif
        default:
...
#if 0
        px_cli_fn_gpio_report_port('f', GPIOF, PX_GPIO_PORT_F, 2, 2);
#endif
    }
    // <regs>
...
#if 0
        px_cli_fn_gpio_report_peripheral('F', GPIOF, 0x0002);
#endif
    }
    else
    // <pin>
