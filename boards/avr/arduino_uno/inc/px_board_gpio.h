...
#define PX_GPIO_D8          PX_GPIO(B, 0, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_D9          PX_GPIO(B, 1, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
...
#define PX_GPIO_I2C_SDA     PX_GPIO(C, 4, PX_GPIO_DIR_IN, PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_I2C_SCL     PX_GPIO(C, 5, PX_GPIO_DIR_IN, PX_GPIO_INIT_PULL_UP)
...
#define PX_GPIO_D2          PX_GPIO(D, 2, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_D3          PX_GPIO(D, 3, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_D4          PX_GPIO(D, 4, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_D5          PX_GPIO(D, 5, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_D6          PX_GPIO(D, 6, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_D7          PX_GPIO(D, 7, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
