...
#define PX_I2C_CFG_SCL_IS_HI()     PX_GPIO_IN_IS_HI(PX_GPIO_I2C_SCL)
#define PX_I2C_CFG_SCL_IS_LO()     PX_GPIO_IN_IS_LO(PX_GPIO_I2C_SCL)
/// @}
...
#define PX_I2C_CFG_SDA_IS_HI()     PX_GPIO_IN_IS_HI(PX_GPIO_I2C_SDA)
#define PX_I2C_CFG_SDA_IS_LO()     PX_GPIO_IN_IS_LO(PX_GPIO_I2C_SDA)
/// @}
