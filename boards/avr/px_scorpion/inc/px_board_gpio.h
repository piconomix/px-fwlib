...
#define PX_GPIO_4          PX_GPIO(C, 2, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_3          PX_GPIO(C, 3, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
...
#define PX_GPIO_SER_RXD    PX_GPIO(D, 0, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_SER_TXD    PX_GPIO(D, 1, PX_GPIO_DIR_OUT, PX_GPIO_INIT_HI)
#define PX_GPIO_2          PX_GPIO(D, 2, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_1          PX_GPIO(D, 3, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
#define PX_GPIO_0          PX_GPIO(D, 4, PX_GPIO_DIR_IN,  PX_GPIO_INIT_PULL_UP)
