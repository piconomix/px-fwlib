...
#define LL_TIM_ETRSOURCE_ADC1_AWD1             (TIM_AF1_ETRSEL_1 | TIM_AF1_ETRSEL_0)   /*!< ETR input is connected to ADC1 analog watchdog 1 */
#define LL_TIM_ETRSOURCE_ADC1_AWD2             TIM_AF1_ETRSEL_2                        /*!< ETR input is connected to ADC1 analog watchdog 2 */
#define LL_TIM_ETRSOURCE_ADC1_AWD3             (TIM_AF1_ETRSEL_2 | TIM_AF1_ETRSEL_0)   /*!< ETR input is connected to ADC1 analog watchdog 3 */
#if defined(TIM2)
#define LL_TIM_ETRSOURCE_LSE                   (TIM_AF1_ETRSEL_1 | TIM_AF1_ETRSEL_0)   /*!< ETR input is connected to LSE */
#define LL_TIM_ETRSOURCE_MCO                   TIM_AF1_ETRSEL_2                        /*!< ETR input is connected to MCO */
#define LL_TIM_ETRSOURCE_MCO2                  (TIM_AF1_ETRSEL_2 | TIM_AF1_ETRSEL_0)   /*!< ETR input is connected to MCO2 */
#endif /* TIM2 */
/**
  * @}
  */
