...
#ifndef __STM32U0xx_HAL_RTC_H
#define __STM32U0xx_HAL_RTC_H
...
{
  RTC_TypeDef               *Instance;  /*!< Legacy register base address. Not used anymore, the driver directly uses
                                             cmsis base address */
...
typedef enum
{
  ...
  HAL_RTC_SSRU_EVENT_CB_ID               = 0x04U,    /*!< RTC SSRU Event Callback ID         */
  HAL_RTC_TAMPER1_EVENT_CB_ID            = 0x05U,    /*!< RTC Tamper 1 Callback ID           */
  HAL_RTC_TAMPER2_EVENT_CB_ID            = 0x06U,    /*!< RTC Tamper 2 Callback ID           */
  HAL_RTC_TAMPER3_EVENT_CB_ID            = 0x07U,    /*!< RTC Tamper 3 Callback ID           */
  HAL_RTC_TAMPER4_EVENT_CB_ID            = 0x08U,    /*!< RTC Tamper 4 Callback ID           */
  HAL_RTC_TAMPER5_EVENT_CB_ID            = 0x09U,    /*!< RTC Tamper 5 Callback ID           */
  HAL_RTC_INTERNAL_TAMPER3_EVENT_CB_ID   = 0x0AU,    /*!< RTC Internal Tamper 3 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER4_EVENT_CB_ID   = 0x0BU,    /*!< RTC Internal Tamper 4 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER5_EVENT_CB_ID   = 0x0CU,    /*!< RTC Internal Tamper 5 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER6_EVENT_CB_ID   = 0x0DU,    /*!< RTC Internal Tamper 6 Callback ID  */
...
#define RTC_FLAG_SSRUF                      0x00000206u    /*!< SSR underflow flag */
