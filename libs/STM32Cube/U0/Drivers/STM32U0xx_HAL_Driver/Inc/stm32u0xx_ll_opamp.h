...
#ifndef STM32U0xx_LL_OPAMP_H
#define STM32U0xx_LL_OPAMP_H
...
/** @defgroup OPAMP_LL_EC_INPUT_NONINVERTING OPAMP input non-inverting
  * @{
  */
#define LL_OPAMP_INPUT_NONINVERT_IO0       0x00000000U           /*!< OPAMP non inverting input connected to GPIO pin (pin PA0 for OPAMP1)             */
#define LL_OPAMP_INPUT_NONINV_DAC1_CH1     (OPAMP_CSR_VP_SEL)    /*!< OPAMP non inverting input connected to DAC1 channel output(channel1 for OPAMP1) */
/**
  * @}
  */
...
/**
  ...
  */
#define __LL_OPAMP_COMMON_INSTANCE(__OPAMPx__) (OPAMP1_COMMON)
