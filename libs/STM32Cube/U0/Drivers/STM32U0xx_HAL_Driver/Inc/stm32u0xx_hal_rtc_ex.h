...
#ifndef __STM32U0xx_HAL_RTC_EX_H
#define __STM32U0xx_HAL_RTC_EX_H
...
#define RTC_INT_TAMPER_ALL                  (RTC_INT_TAMPER_3 | RTC_INT_TAMPER_4 |\
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV4096   (TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_1) /*!< Each of the tamper 
                                                                                                     inputs are sampled
                                                                                                     with a frequency = 
                                                                                                     RTCCLK / 4096  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV2048   TAMP_FLTCR_TAMPFREQ_2                           /*!< Each of the tamper 
                                                                                                     inputs are sampled
                                                                                                     with a frequency = 
                                                                                                     RTCCLK / 2048  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV1024   (TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_2) /*!< Each of the tamper
                                                                                                     inputs are sampled
                                                                                                     with a frequency = 
                                                                                                     RTCCLK / 1024  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV512    (TAMP_FLTCR_TAMPFREQ_1 | TAMP_FLTCR_TAMPFREQ_2) /*!< Each of the tamper
                                                                                                     inputs are sampled
                                                                                                     with a frequency = 
                                                                                                     RTCCLK / 512   */
...
/** @defgroup RTCEx_Private_Constants RTCEx Private Constants
  * @{
  */
#define RTC_EXTI_LINE_ALARM_EVENT             EXTI_IMR1_IM28 /*!< External interrupt line 28 Connected to the RTC Alarm event */
#define RTC_EXTI_LINE_TIMESTAMP_EVENT         EXTI_IMR1_IM28 /*!< External interrupt line 28 Connected to the RTC Time Stamp events */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT       EXTI_IMR1_IM28 /*!< External interrupt line 28 Connected to the RTC Wakeup event */
#define RTC_EXTI_LINE_TAMPER_EVENT            EXTI_IMR1_IM29 /*!< External interrupt line 29 Connected to the RTC tamper events */
#define RTC_EXTI_LINE_SSRU_EVENT              EXTI_IMR1_IM28 /*!< External interrupt line 28 Connected to the RTC SSR Underflow event  */
/**
  * @}
  */
