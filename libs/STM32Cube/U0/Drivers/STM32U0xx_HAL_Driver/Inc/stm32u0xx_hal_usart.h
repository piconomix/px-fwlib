...
#ifndef STM32U0xx_HAL_USART_H
#define STM32U0xx_HAL_USART_H
...
/** @brief  Check USART Baud rate.
  ...
  *         The maximum Baud Rate is derived from the maximum clock on U0 (i.e. 48 MHz)
...
#include "stm32u0xx_hal_usart_ex.h"
