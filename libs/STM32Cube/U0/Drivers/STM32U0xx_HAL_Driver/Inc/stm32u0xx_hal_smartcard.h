/**
  ******************************************************************************
  * @file    stm32u0xx_hal_smartcard.h
...
#ifndef STM32U0xx_HAL_SMARTCARD_H
#define STM32U0xx_HAL_SMARTCARD_H
...
/** @brief  Check the Baud rate range.
  * @note   The maximum Baud Rate is derived from the maximum clock on U0 (48 MHz)
  ...
  */
#define IS_SMARTCARD_BAUDRATE(__BAUDRATE__) ((__BAUDRATE__) < 3000000U)
...
#include "stm32u0xx_hal_smartcard_ex.h"
...
#endif /* STM32U0xx_HAL_SMARTCARD_H */
